...
{
	GTCX
	RTOTC (F965_7247,13528,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F965_7252,13533,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F965_7253,13534,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F965_7254,13527,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit965 (void)
{
	GTCX
	RTOTS (7247,F965_7247)
	RTOTS (7248,F965_7248)
	RTOTS (7249,F965_7249)
	RTOTS (7250,F965_7250)
