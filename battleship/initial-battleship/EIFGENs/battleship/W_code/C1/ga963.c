...
extern EIF_TYPED_VALUE F963_7235(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F963_7236(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F963_7237(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13521);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
/* {GAME}.generate_ships */
EIF_TYPED_VALUE F963_7235 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 962, Current, 6, 3, 13522);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		ur1 = RTCCL(Result);
		ur2 = RTCCL(loc6);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5025, dtype))(Current, ur1x, ur2x)).it_b);
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(15);
			ur1 = RTCCL(loc6);
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 962, Current, 8, 2, 13523);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
/* {GAME}.collide_with */
EIF_TYPED_VALUE F963_7237 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 962, Current, 2, 2, 13524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		if (!Result) {
			...
			ur2 = RTCCL(tr1);
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5024, dtype))(Current, ur1x, ur2x)).it_b);
			tb2 = tb3;
		}
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			ur2 = RTCCL(tr1);
			tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5024, dtype))(Current, ur1x, ur2x)).it_b);
			tb2 = tb4;
			RTHOOK(7);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 962, Current, 4, 0, 13525);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(962, Current, 13525);
	RTIV(Current, RTAL);
	RTHOOK(1);
