...
extern EIF_TYPED_VALUE F971_7313(EIF_REFERENCE);
...
extern void F971_7318(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F971_7323(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 13580);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5085, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 13581);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5085, dtype));
...
EIF_TYPED_VALUE F971_7308 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(5084,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F971_7310 (EIF_REFERENCE Current)
{
	...
	Result = *(EIF_REAL_64 *)(Current + RTWA(5084, dtype));
...
EIF_TYPED_VALUE F971_7311 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5084, Dtype(Current)));
...
EIF_TYPED_VALUE F971_7313 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	ui4_1 = ti4_3;
	ti4_2 = eif_bit_and(ti4_1,ui4_1);
	*(EIF_INTEGER_32 *)(Current + RTWA(5085, dtype)) = (EIF_INTEGER_32) ti4_2;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5085, 0x10000000, 1); /* compact_time */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5085, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 0, 1, 13589);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 13589);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 1, 1, 13572);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 13572);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("s_large_enough", EX_PRE);
...
void F971_7318 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 970, Current, 0, 1, 13573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 13573);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5084, 0x20000000, 1); /* fractional_second */
	*(EIF_REAL_64 *)(Current + RTWA(5084, dtype)) = (EIF_REAL_64) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F971_7323 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
