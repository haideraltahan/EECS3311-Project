...
extern EIF_TYPED_VALUE F999_7757(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_7758(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_7759(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_7760(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F999_7761(EIF_REFERENCE);
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 998, Current, 3, 0, 14013);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14013);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr1;
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5444, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	tb1 = '\0';
	...
	if (tb1) {
		...
		ur1 = tr1;
		loc3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5444, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTHOOK(6);
		tb1 = '\0';
...
RTOID (F999_7757)
EIF_TYPED_VALUE F999_7757 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 998, Current, 2, 0, 14014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14014);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 2, 0xF80000E8, 0, 0); /* loc2 */
...
RTOID (F999_7758)
EIF_TYPED_VALUE F999_7758 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 998, Current, 1, 0, 14015);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14015);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F999_7759 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14016);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14016);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F999_7760 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 998, Current, 1, 1, 14017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14017);
...
RTOID (F999_7761)
EIF_TYPED_VALUE F999_7761 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14018);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14018);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void EIF_Minit999 (void)
{
	...
	RTOTS (7757,F999_7757)
	RTOTS (7758,F999_7758)
	RTOTS (7761,F999_7761)
}
