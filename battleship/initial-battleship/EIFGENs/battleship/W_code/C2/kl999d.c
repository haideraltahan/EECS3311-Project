...
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,153,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 14016, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01D1 /*232*/), 14017, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 14018, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 879, 998);
}
