...
static const struct desc_info desc_980[] = {
	...
	{EIF_NON_GENERIC(0x01BB /*221*/), 14745, 4},
	{EIF_NON_GENERIC(0x01BB /*221*/), 14746, 8},
	{EIF_NON_GENERIC(0x01BB /*221*/), 14742, 12},
	{EIF_NON_GENERIC(0x0191 /*200*/), 14743, 0},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
	IDSC(desc_980 + 1, 1, 979);
	IDSC(desc_980 + 32, 458, 979);
}
