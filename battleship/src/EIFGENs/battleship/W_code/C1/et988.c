/*
 * Code for class reference ETF_GAME_ACCESS
 */
...
extern void F988_16468(EIF_REFERENCE, int);
...
void F988_16468 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 987, Current, 0, 16467);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
