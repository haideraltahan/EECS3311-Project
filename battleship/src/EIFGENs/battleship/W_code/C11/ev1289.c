...
extern EIF_TYPED_VALUE F1289_11636(EIF_REFERENCE);
extern void F1289_11637(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1289_11636 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1289_11637 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1288, Current, 0, 0, 18433);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1288, Current, 18433);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8440, 0xF8000595, 0); /* implementation */
