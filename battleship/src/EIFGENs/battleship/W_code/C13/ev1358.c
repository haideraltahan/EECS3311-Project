...
static EIF_TYPED_VALUE F1358_12474_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1358_12474_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1358_12474 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1358_12474_body (Current)).it_r;
