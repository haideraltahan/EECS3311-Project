...
extern EIF_TYPED_VALUE F1392_13228(EIF_REFERENCE);
extern void F1392_13229(EIF_REFERENCE);
extern void F1392_13230(EIF_REFERENCE);
static EIF_TYPED_VALUE F1392_13236_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1392_13236(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1392_13227 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19829);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19829);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\01';
	...
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10133, dtype))(Current)).it_b);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
EIF_TYPED_VALUE F1392_13228 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1392_13229 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19831);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19831);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1392_13230 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19832);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10126, 0x04000000, 1); /* internal_non_sensitive */
...
static EIF_TYPED_VALUE F1392_13236_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19833);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1391, Current, 19833);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1392_13236 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1392_13236_body (Current)).it_r;
