...
extern EIF_TYPED_VALUE F1392_13237(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1392_13238(EIF_REFERENCE);
extern void F1392_13239(EIF_REFERENCE);
extern void F1392_13240(EIF_REFERENCE);
extern void F1392_13241(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1392_13242_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1392_13242(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1392_13237 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1392_13238 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1392_13239 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1391, Current, 2, 0, 19834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19834);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10130, 0x04000000, 1); /* is_docking_enabled */
	*(EIF_BOOLEAN *)(Current + RTWA(10130, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (EIF_TEST(loc1)) {
		...
		RTNHOOK(4,1);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9685, "dockable_targets", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,2);
...
void F1392_13240 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1391, Current, 2, 0, 19835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19835);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("application_exists", EX_PRE);
...
void F1392_13241 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1391, Current, 0, 1, 19836);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19836);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {269,0xFF01,0xFFF9,1,186,0xFF01,1263,203,0xFFFF};
			EIF_TYPE typres0;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10129, 0xF800010D, 0); /* veto_dock_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1392_13242_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19837);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1391, Current, 19837);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1392_13242 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1392_13242_body (Current)).it_r;
