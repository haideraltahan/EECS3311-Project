...
static EIF_TYPED_VALUE F1395_13249_body(EIF_REFERENCE);
...
void F1395_13247 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1394, Current, 0, 0, 19840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1394, Current, 19840);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1395_13249_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1394, Current, 0, 0, 19841);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1394, Current, 19841);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1395_13249 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1395_13249_body (Current)).it_r;
