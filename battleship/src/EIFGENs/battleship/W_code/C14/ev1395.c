...
extern void F1395_13249(EIF_REFERENCE);
static EIF_TYPED_VALUE F1395_13251_body(EIF_REFERENCE);
...
void F1395_13249 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1394, Current, 0, 0, 19842);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1394, Current, 19842);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10136, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1395_13251_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1394, Current, 0, 0, 19843);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1394, Current, 19843);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1395_13251 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1395_13251_body (Current)).it_r;
