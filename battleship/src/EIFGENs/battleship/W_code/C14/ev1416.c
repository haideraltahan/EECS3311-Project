...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1415, l_feature_name, 1, RTWCT(9372, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1416_13387 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1415, Current, 3, 0, 19941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up2 = tp2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5802, 968))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1216_334, (EIF_POINTER)(0),8228, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1216_335, (EIF_POINTER)(0),8229, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9894, dtype))(Current, up1x, ur1x, ur2x, ur3x);
	...
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10201, dtype))(Current, ur1x);
	RTHOOK(12);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9385, dtype))(Current, ub1x);
	if (RTAL & CK_ENSURE) {
...
EIF_TYPED_VALUE F1416_13389 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10218,Dtype(Current)));
	return r;
}


/* {EV_DIRECTORY_DIALOG_IMP}.set_start_path */
void F1416_13390 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1415, Current, 1, 1, 19944);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1415, Current, 19944);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10218, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10218, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1416_13391_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1415, Current, 0, 0, 19945);
	RTSA(Dtype(Current));
	RTSC;
