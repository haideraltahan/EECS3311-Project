...
extern void F1434_13688(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1434_13689(EIF_REFERENCE);
static EIF_TYPED_VALUE F1434_13690_body(EIF_REFERENCE);
...
void F1434_13688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1433, Current, 0, 1, 20184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1433, Current, 20184);
	RTCC(arg1, 1433, l_feature_name, 1, RTWCT(9372, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1434_13689 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1433, Current, 0, 0, 20185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1433, Current, 20185);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1434_13690_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1433, Current, 0, 0, 20186);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1434_13690 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1434_13690_body (Current)).it_r;
