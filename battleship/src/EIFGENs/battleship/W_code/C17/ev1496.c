...
static EIF_TYPED_VALUE F1496_14759_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1496_14759_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1495, Current, 0, 0, 21070);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1495, Current, 21070);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1496_14759 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9374, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1496_14759_body (Current)).it_r;
