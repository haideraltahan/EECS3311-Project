...
extern void F1548_15656(EIF_REFERENCE);
extern void F1548_15657(EIF_REFERENCE);
...
void F1548_15656 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11464, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1548_15657 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1547, Current, 0, 0, 21821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1547, Current, 21821);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
		...
		if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\015')) {
			...
			if ((EIF_BOOLEAN) !tb1) {
				...
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\012')) {
					...
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11465, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					RTNHOOK(10,1);
					tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8012, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
					ur1 = RTCCL(tr2);
...
{
	GTCX
	RTOTC (F1548_15658,21823,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1548 (void)
{
	GTCX
	RTOTS (15658,F1548_15658)
}
