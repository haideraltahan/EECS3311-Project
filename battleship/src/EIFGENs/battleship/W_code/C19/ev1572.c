...
extern void F1572_13056(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1572_13057(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1572_13058(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1572_13061(EIF_REFERENCE);
static EIF_TYPED_VALUE F1572_13062_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1572_13062(EIF_REFERENCE);
...
void F1572_13056 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1571, Current, 0, 0, 19702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1571, Current, 19702);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9998, 0xF8000101, 0); /* child_array */
	tr1 = RTLNSMART(RTWCT(9998, dtype, Dftype(Current)).id);
	ui4_1 = ((EIF_INTEGER_32) 0L);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3080, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(9998, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1572_13057 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1571, Current, 0, 1, 19703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1571, Current, 19703);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1572_13058 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1571, Current, 0, 0, 19704);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1571, Current, 19704);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1572_13061 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9998,Dtype(Current)));
	return r;
}


/* {EV_DYNAMIC_LIST_IMP}.interface */
static EIF_TYPED_VALUE F1572_13062_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1571, Current, 0, 0, 19706);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1571, Current, 19706);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1572_13062 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1572_13062_body (Current)).it_r;
