...
extern EIF_TYPED_VALUE F1009_8697(EIF_REFERENCE);
static EIF_TYPED_VALUE F1009_8698_body(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1009_8697 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1008, Current, 1, 0, 15019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1008, Current, 15019);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6485, 0xF8000482, 0); /* change_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6485, dtype)) = (EIF_REFERENCE) tr1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1009_8698_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1009_8698 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6485, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1009_8698_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6485,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
