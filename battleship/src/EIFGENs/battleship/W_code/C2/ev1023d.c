...
static const EIF_TYPE_INDEX egt_13_1023 [] = {0xFF01,1147,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1023 [] = {0xFF01,1154,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1023 [] = {0xFF01,1147,0xFFFF};
...
static const struct desc_info desc_1023[] = {
	...
	{EIF_GENERIC(egt_13_1023), 15081, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1023), 15082, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1023), 15083, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F7 /*1147*/), 15084, 0},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 15085, 8},
	{EIF_NON_GENERIC(0x08F7 /*1147*/), 15086, 16},
};
void Init1023(void)
{
	IDSC(desc_1023, 0, 1022);
	IDSC(desc_1023 + 1, 1, 1022);
	IDSC(desc_1023 + 32, 739, 1022);
}
