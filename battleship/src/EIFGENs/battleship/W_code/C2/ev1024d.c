...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,1154,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_13_1024), 15087, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 15088, 0},
