...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,1154,0xFFFF};
static const EIF_TYPE_INDEX egt_14_994 [] = {0xFF01,1154,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 14903, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 14904, 0},
	{EIF_GENERIC(egt_14_994), 14905, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 14906, 8},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
	IDSC(desc_994 + 1, 1, 993);
	IDSC(desc_994 + 32, 976, 993);
}
