...
static const EIF_TYPE_INDEX egt_13_1000 [] = {0xFF01,1110,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1000 [] = {0xFF01,1159,0xFFFF};
...
static const struct desc_info desc_1000[] = {
	...
	{EIF_GENERIC(egt_13_1000), 14925, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1000), 14926, 0xFFFFFFFF},
};
void Init1000(void)
{
	IDSC(desc_1000, 0, 999);
	IDSC(desc_1000 + 1, 1, 999);
	IDSC(desc_1000 + 32, 925, 999);
}
