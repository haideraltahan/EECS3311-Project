...
static const EIF_TYPE_INDEX egt_13_1003 [] = {0xFF01,1177,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1003 [] = {0xFF01,1164,0xFFFF};
...
static const struct desc_info desc_1003[] = {
	...
	{EIF_GENERIC(egt_13_1003), 14948, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1003), 14949, 0xFFFFFFFF},
};
void Init1003(void)
{
	IDSC(desc_1003, 0, 1002);
	IDSC(desc_1003 + 1, 1, 1002);
	IDSC(desc_1003 + 32, 885, 1002);
}
