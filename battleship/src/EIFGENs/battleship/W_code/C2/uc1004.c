...
extern EIF_TYPED_VALUE F1004_8628(EIF_REFERENCE);
...
RTOID (F1004_8628)
EIF_TYPED_VALUE F1004_8628 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 14950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
