...
extern EIF_TYPED_VALUE F1624_8860(EIF_REFERENCE);
extern void F1624_8861(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1624_8862(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1624_8860 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1624_8861 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1623, Current, 0, 1, 15165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1623, Current, 15165);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6640, 0xF8000657, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1624_8862 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1623, Current, 0, 0, 15166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1623, Current, 15166);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6640, 0xF8000657, 0); /* right */
