...
extern void F1046_9043(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1046_9044(EIF_REFERENCE);
extern void F1046_9045(EIF_REFERENCE);
extern void F1046_9046(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1046_9047(EIF_REFERENCE);
...
void F1046_9043 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1045, Current, 0, 4, 15324);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1045, Current, 15324);
	RTCC(arg1, 1045, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTCC(arg2, 1045, l_feature_name, 2, eif_new_type(232, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,903,0xFF01,1048,0xFFFF};
		EIF_TYPE typres0;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6820, 0xF8000387, 0); /* test_classes */
	tr1 = RTCCL(arg3);
	RTAR(Current, tr1);
...
void F1046_9044 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1045, Current, 0, 0, 15325);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1045, Current, 15325);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1046_9045 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1045, Current, 4, 0, 15326);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7230, "is_violation_case", loc4))(loc4)).it_b);
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc4 + RTVA(7233, "passed", loc4));
					if (tb3) {
						RTHOOK(18);
						RTDBGAA(Current, dtype, 6815, 0x10000000, 1); /* number_passed_violation */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1045, Current, 7, 0, 15327);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1046_9047 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
