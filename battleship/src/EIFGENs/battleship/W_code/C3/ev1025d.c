...
static const EIF_TYPE_INDEX egt_13_1025 [] = {0xFF01,1154,0xFFFF};
...
static const struct desc_info desc_1025[] = {
	...
	{EIF_GENERIC(egt_13_1025), 15088, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 15089, 0},
};
void Init1025(void)
{
	IDSC(desc_1025, 0, 1024);
	IDSC(desc_1025 + 1, 1, 1024);
	IDSC(desc_1025 + 32, 730, 1024);
}
