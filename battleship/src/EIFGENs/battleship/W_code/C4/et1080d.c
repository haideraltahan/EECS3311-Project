...
static const struct desc_info desc_1080[] = {
	...
	{EIF_GENERIC(egt_9_1080), 15628, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x018B /*197*/), 15630, 0},
	{EIF_NON_GENERIC(0x018B /*197*/), 15631, 8},
	{EIF_GENERIC(egt_13_1080), 15632, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1080), 15633, 0xFFFFFFFF},
};
void Init1080(void)
{
	IDSC(desc_1080, 0, 1079);
	IDSC(desc_1080 + 1, 1, 1079);
	IDSC(desc_1080 + 32, 449, 1079);
	IDSC(desc_1080 + 35, 429, 1079);
}
