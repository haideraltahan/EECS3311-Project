...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1087, Current, 0, 0, 15659);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1088_9420 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1087, Current, 0, 0, 15660);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F1088_9421 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1087, Current, 0, 0, 15661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1087, Current, 15661);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E8, 0,0); /* Result */
