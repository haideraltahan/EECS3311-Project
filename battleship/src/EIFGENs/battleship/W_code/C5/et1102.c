...
extern void F1102_9495(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1102_9496(EIF_REFERENCE);
...
/* {ETF_TUPLE_ARG}.make */
void F1102_9495 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1101, Current, 0, 1, 15735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_REFERENCE *)(Current + RTWA(7193, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7214, 0xF8000154, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
/* {ETF_TUPLE_ARG}.value */
EIF_TYPED_VALUE F1102_9496 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1101, Current, 1, 0, 15737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
